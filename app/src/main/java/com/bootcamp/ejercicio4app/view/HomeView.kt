package com.bootcamp.ejercicio4app.view
...
import com.bootcamp.ejercicio4app.navigation.Screen
    ...
    Column {
        TopAppBar(
            ...
            colors = TopAppBarDefaults.topAppBarColors(
                containerColor = Color(0xFFF36390),
...
fun ArticleCard(article: Article, navController: NavHostController) {
    Card(
        modifier = Modifier
            ...
            .fillMaxWidth()
            .clickable {
                navController.navigate(Screen.DetailsNew.route + "/${article.title}")
            }
    ) {
        Column(
